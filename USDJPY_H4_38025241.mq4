...
input int Take_Profit = 241; // Take Profit (pips)
static input string Ind0 = "------------";// ----- Directional Indicators -----
input int Ind0Param0 = 12; // Period
static input string Ind2 = "------------";// ----- Stochastic -----
input int Ind2Param0 = 13; // %K Period
input int Ind2Param1 = 12; // %D Period
input int Ind2Param2 = 15; // Slowing
input int Ind2Param3 = 20; // Level
...
static input int Magic_Number = 38025241; // Magic Number
...
void ManageOpen()
  {
   double ind0val1 = iADX(NULL,0,Ind0Param0,PRICE_CLOSE,1,1) - iADX(NULL,0,Ind0Param0,PRICE_CLOSE,2,1);
   double ind0val2 = iADX(NULL,0,Ind0Param0,PRICE_CLOSE,1,2) - iADX(NULL,0,Ind0Param0,PRICE_CLOSE,2,2);
   ...
   double ind2val1 = iStochastic(NULL,0,Ind2Param0,Ind2Param1,Ind2Param2,MODE_SMA,STO_LOWHIGH,MODE_MAIN,1);
   double ind2val2 = iStochastic(NULL,0,Ind2Param0,Ind2Param1,Ind2Param2,MODE_SMA,STO_LOWHIGH,MODE_MAIN,2);
...
void ManageClose()
  {
   double ind3val1 = iADX(NULL,0,Ind3Param0,PRICE_CLOSE,1,1) - iADX(NULL,0,Ind3Param0,PRICE_CLOSE,2,1);
   double ind3val2 = iADX(NULL,0,Ind3Param0,PRICE_CLOSE,1,2) - iADX(NULL,0,Ind3Param0,PRICE_CLOSE,2,2);
...
//+------------------------------------------------------------------+
/*STRATEGY MARKET ICMarkets-Live18; USDJPY; H4 */
/*STRATEGY CODE {"properties":{"entryLots":0.01,"stopLoss":86,"takeProfit":241,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Directional Indicators","listIndexes":[0,0,0,0,0],"numValues":[12,0,0,0,0,0]},{"name":"Accumulation Distribution","listIndexes":[1,0,0,0,0],"numValues":[0,0,0,0,0,0]},{"name":"Stochastic","listIndexes":[0,0,0,0,0],"numValues":[13,12,15,20,0,0]}],"closeFilters":[{"name":"Directional Indicators","listIndexes":[0,0,0,0,0],"numValues":[24,0,0,0,0,0]}]} */
